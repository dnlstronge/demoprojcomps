...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1799)), "/Users/danielstronge/Desktop/demoProj/demoprojcomps/src/app/page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4232)), "/Users/danielstronge/Desktop/demoProj/demoprojcomps/src/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/danielstronge/Desktop/demoProj/demoprojcomps/src/app/page.tsx"];
...
const code = (/* unused pure expression or super */ null && (`<h3 style={{
...
/* hardcoded examples  */ const sampleCounter = `
...
function Home() {
  ...
  save output to db, retrieve on select saved and populate state with use effect  */ const [codeInput, setCodeInput] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(``);
    const [toggleInline, setToggleInline] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    /* change state & code input / handlers */ const handleInput = (e)=>{
        if (e.currentTarget.value === "button") {
            setCodeInput(sampleButton);
        }
        if (e.currentTarget.value === "div") {
            setCodeInput(sampleDiv);
        }
        if (e.currentTarget.value === "head") {
            setCodeInput(sampleHead);
        }
        if (e.currentTarget.value === "wrapper") {
            setCodeInput(sampleWrapper);
        }
        if (e.currentTarget.value === "click") {
            setCodeInput(sampleCounter);
        }
    };
    const handleReset = ()=>{
        setCodeInput("");
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/danielstronge/Desktop/demoProj/demoprojcomps/src/app/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,864,149], () => (__webpack_exec__(5125)));
